...
@Component({
  ...
  styleUrls: ['./video-activity.component.css'],
})
...
truePhotos = 0;
 ...
 startWithoutCamera() {
  ...
  questions = [
    {
            ...
            audio: {
                questionAudio: '/assets/A3/audios/choices.mp3',  
                correctAudio: '/assets/All/correct.mp3',   
                wrongAudio: '/assets/A3/audios/wrong1.mp3'      
            },
            choices: [
                { img: '/assets/All/images/cow.png', isCorrect: false },
                { img: '/assets/All/images/cat.png', isCorrect: true },
                { img: '/assets/All/images/dog.png', isCorrect: false }
            ]
        },
        {
            type: 'image-choice',
            ...
            audio: {
                questionAudio: '/assets/A3/audios/choices.mp3',  
                correctAudio: '/assets/All/correct.mp3',   
                wrongAudio: '/assets/A3/audios/wrong2.mp3'      
            },
            choices: [
                { img: '/assets/All/images/cow.png', isCorrect: true },
                { img: '/assets/All/images/cat.png', isCorrect: false },
                { img: '/assets/All/images/dog.png', isCorrect: false }
            ]
        },
        {
            ...
            audio: {
                questionAudio: '/assets/A3/audios/choices.mp3',  
                correctAudio: '/assets/All/correct.mp3',   
                wrongAudio: '/assets/A3/audios/wrong3.mp3'      
            },
            choices: [
                { img: '/assets/All/images/cow.png', isCorrect: false },
                { img: '/assets/All/images/cat.png', isCorrect: false },
                { img: '/assets/All/images/dog.png', isCorrect: true }
            ]
        }
    ];
  ...
  if (!this.pausedForQuestions && this.currentQuestionIndex === 0 && video.currentTime >= 34) {
  ...
  else if (!this.pausedForQuestions && this.currentQuestionIndex === 1 && video.currentTime >= 44) {
    this.pausedForQuestions = true;
    video.pause();
    this.showQuestionOverlay = true;
    this.currentQuestion = this.questions[this.currentQuestionIndex];
